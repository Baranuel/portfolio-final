...
export default function ContactSection (){
  const {data} = useGetEndorsements()
    ...
    return(
        <section id='Contact' className="bg-stone-950 w-full relative min-h-[800px] h-fit pt-[75px] py-12 px-52 2xl:px-24 lg:px-12 md:px-8 sm:px-4 xs:p-2 max-w-[100vw] flex flex-col gap-3 items-center justify-center">
