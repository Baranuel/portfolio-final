...
export const WorkSection = async () => {
  ...
  return (
    <section id='Work' className="w-full relative min-h-[500px] h-fit py-[100px]  flex flex-col gap-3 items-center justify-start">
      <span className="tracking-[.25rem] whitespace-nowrap self-center text-center  w-full sm:text-sm text-base  font-semibold  text-transparent bg-clip-text bg-gradient-to-b from-violet-700 to-red-800">
        BUILDING PROJECTS
      </span>
      ...
      <p className="text-sectionSubtitle sm:text-[16px] text-primaryGrey/80 text-center">
       Larger Projects I have been working on
      </p>
