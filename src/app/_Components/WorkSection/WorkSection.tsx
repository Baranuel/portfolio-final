...
export const WorkSection = () => {
    ...
    <p className="text-sectionSubtitle text-primaryGrey/80 text-center">All the Projects I have worked on so far.</p>
    <div className=" relative z-10 w-full  max-w-[1500px] overflow-hidden px-24 2xl:px-10 xl:px-4 sm:px-0  flex flex-col items-center justify-center ">
